  ...
  return (
    <div className="">
      <nav className="flex p-4 border-b-[0.5px] border-amber-500/20">
        <h2 className="text-amber-500 font-black text-xl md:text-2xl">
          Worksy
        </h2>
      </nav>
      <main className="flex flex-col md:flex-row p-4 md:p-10 items-center gap-4 md:gap-8">
        <section className="flex-1 space-y-4 md:space-y-6 text-center md:text-left p-4">
          <p className="text-amber-500 font-semibold text-base md:text-base">
        ...
        <section className="bg-gold/10 p-4 md:p-8 rounded-2xl flex-1 md:mr-6">
          <AuthForm />
        </section>
      </main>
    </div>
